...
function setup() {
  ...
  boidCountElement = createP('Boid Count: ' + boidCount).style('color', '#0A5AFE').style("font-weight", "bold").position(160, 0);

  let showCloudsCheckbox = createCheckbox('Show Clouds', false).style('color', '#0A5AFE').style("font-weight", "bold").position(160, 60);
